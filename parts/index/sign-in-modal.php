<div class="sign-in__wrppr mdl__wrppr">
    <div class="sign-in mdl">
        <span class="sign-in__close mdl__close">&times;</span>
        <div class="sign-in__content">
            ...
            <a class="sign-in__open-sign-up">Еще не зарегистрированы?</a>
        </div>
    </div>
</div>